...
RSpec.describe LawyerProfile, type: :model do
  ...
  let!(:lawyer_profile) {FactoryGirl.create :lawyer_profile, law_firm: law_firm, is_manager: true}
  ...
  describe "can_out" do
    let!(:lawyer_profile) {FactoryGirl.create :lawyer_profile, law_firm: law_firm, is_manager: false}
    it do
